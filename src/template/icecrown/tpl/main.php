                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade in <?php echo((empty($error_error) && empty($success_msg)) ? 'active' : ''); ?>"
                        ...
                        <p style="text-align: center">
                            My son... the day you were born, the very forests of Lordaeron whispered the name..."Arthas".<br>
                            My child, I watched with pride as you grew into a weapon of righteousness.<br>
                            Remember - our line has always ruled with wisdom and strength.<br>
                            And I know you will show restraint when exercising your great power.<br>
                            But the truest victory, my son - is stirring the hearts of your people.<br>
                            I tell you this, for when my days have come to an end - <br>
                            You, shall be King.<br>
                        </p>
                        <p><?php elang('edit_on'); ?> template/<?php echo $antiXss->xss_clean(get_config("template")); ?>/tpl/main.php</p>
                    </div>
                    <div class="tab-pane fade in <?php echo(!(empty($error_error) && empty($success_msg)) ? 'active' : ''); ?>"
                         id="pills-register">
                        <div class="row">
